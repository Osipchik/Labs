...
//         public static FloatBinary operator *(FloatBinary fb1, FloatBinary fb2)
//         {
//             if(fb1.CheckZero() || fb2.CheckZero()) 
//                 return new FloatBinary(false, ZeroExp, ZeroMantissa);
//
//             var exponent = AddExponents(fb1._exponent, fb2._exponent);
//             var (m1, m2) = ExpandMantissas(fb1, fb2, new[] {1, 1});
//
//             var mRes = (new Binary(m1) * new Binary(m2)).Value.ToList();
//             //mRes.RemoveRange(0, 2);
//             if (mRes[0] == 0 && mRes[1] == 1)
//             {
//                 mRes.RemoveRange(0, 2);
//                 mRes = mRes.GetRange(0, (int) BinaryConstants.Mantissa);
//             }
//
//             return new FloatBinary(fb1._isNegative != fb2._isNegative, exponent, mRes);
//         }
//         
//         
//
//         private static IEnumerable<int> AddExponents(IEnumerable<int> exp1, IEnumerable<int> exp2)
//         {
//             var expBin1 = new Binary(exp1) + new Binary(-(int) BinaryConstants.Exp);
//             var expBin2 = new Binary(exp2) + new Binary(-(int) BinaryConstants.Exp);
//             var res = (expBin1 + expBin2) + new Binary((int) BinaryConstants.Exp);
//             if (res.Value.First() == 1)
//             {
...
//         
//         
//         private static IEnumerable<int> Add(IList<int> bin1, IList<int> bin2)
//         {
//             var res = new List<int>();
//             var temp = 0;
//
//             for (var i = bin1.Count - 1; i >= 0; i--)
//             {
